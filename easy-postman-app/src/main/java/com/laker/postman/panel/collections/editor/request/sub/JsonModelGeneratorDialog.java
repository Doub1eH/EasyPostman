...
public final class JsonModelGeneratorDialog extends JDialog {
    ...
    private JsonModelGeneratorDialog(Component owner, String json, String suggestedRootName) {
        ...
        languageCombo.addActionListener(event -> regenerate());
    ...
    private JComponent createContent() {
        ...
        JPanel form = new JPanel(new MigLayout("insets 0,fillx,novisualpadding", "[right]8[180!,fill]18[right]8[grow,fill]", "[]"));
